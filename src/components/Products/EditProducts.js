...
class EditProducts extends Component
{
    ...
    componentDidMount()
    {
        database.ref("products").child(`${this.props.match.params.id}`).on('value', (snapshot) => {
            const {title, description, titleColor} = snapshot.val();
            this.setState({
                title,
                description,
                titleColor,
    ...
    handleSubmit(e)
    {
        ...
        database.ref("products").child(`${this.props.match.params.id}`).update(productItem);
